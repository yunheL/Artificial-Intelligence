...
public class DrawableTree 
{
	...
	public String plurality(XML dataset) { return ""; }
	public String chooseSplitAttribute(XML dataset) { return ""; }
	public double calculatePostSplitEntropy(String attribute, XML dataset) { return 0; }
	public double calculateEntropy(XML dataset) { return 0; }
	public static double B(double q) { return 0; }
	
	public double runTests(String filename) { return 0; }
	public String predict(XML example, XML decisionTree) { return ""; }	
}
